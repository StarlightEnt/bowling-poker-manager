// PATH: app/[leagueSlug]/[seasonSlug]/checkin/page.js
'use client';
...
export default function CheckinPage({ params }) {
  ...
  async function loadData(week = null) {
    ...
    try {
      const url = week
        ? `/api/${leagueSlug}/${seasonSlug}/checkin?week=${week}`
        : `/api/${leagueSlug}/${seasonSlug}/checkin`;
  ...
  async function toggleCheckin(bowler) {
    ...
    try {
      await fetch(`/api/${leagueSlug}/${seasonSlug}/checkin`, {
        method: 'POST',
  ...
  async function toggleLock() {
    ...
    try {
      ...
      const res = await fetch(`/api/${leagueSlug}/${seasonSlug}/checkin`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({
          seasonId: data.seasonId,
  ...
  async function saveEdit() {
    ...
    try {
      const res = await fetch(`/api/${leagueSlug}/${seasonSlug}/checkin/edit-name`, {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
